...
texto_t concatenar_texto(const texto_t t1, const texto_t t2) {
   texto_t res = new rep_texto;
   res->caracteres = new char [longitud_texto(t1)+longitud_texto(t2)+1];
