...
/* NUEVA */
/*
  Devuelve `true` si algún elemento de `lst` cumple que su dato de texto es `t`,
  en cuyo caso además devuelve en `n` el dato numérico del primer elemento que
  lo cumple, o devuelve `false` y `n` es ignorado.
 */
